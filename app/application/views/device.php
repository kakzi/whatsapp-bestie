...
<body>
                                            ...
                                            <div class="widget-stats-large-chart-container">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="imageee text-center" id="area-image-<?= $row->nomor ?>">
                                                        <img src="<?= _assets("images/login.png") ?>" height="300px" alt="">
                                                    </div>
    ...
    <script>
        ...
        //web socket yang di peroleh dari app_node
        ...
        socket.on('authenticated', function(src) {
            ...
            // $("#logoutbutton").html('')
            $(`#area-image-${src.id}`).html(`<img src="<?= _assets("images/login.png") ?>" alt="cardimg" id="qrcode" height="300px" style="max-height: 100%">`);
