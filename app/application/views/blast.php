                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-off mb-2" id="form-message">
                                                        ...
                                                        <textarea name="pesan" class="form-control" rows="7" placeholder="Contoh : Assalamualaikum {name} , ApaKabar?" required></textarea>
                                                    </div>
                                                    ...
                                                    <span class="form-off" id="form-button-urlcall">
                                                        <div class="row">
                                                            <div class="col-12 col-xl-6 col-lg-6 col-md-6">
                                                                ...
                                                                <input type="text" class="form-control" name="btnurl" placeholder="ex: wabestie" autocomplete="off">
                                                            </div>
                                                            <div class="col-12 col-xl-6 col-lg-6 col-md-6">
                                                                <label class="form-label">Web Url</label>
                                                                <input type="text" class="form-control" name="btnurl_val" placeholder="ex: https://wabestie.com" autocomplete="off">
                                                            </div>
                                                            <div class="col-12 col-xl-6 col-lg-6 col-md-6">
