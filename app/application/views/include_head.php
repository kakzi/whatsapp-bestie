<div class="app-sidebar">
    <div class="logo">
        <a href="#" class="logo-icon" style="background: url(<?= _assets('images/nadeendeveloper.png') ?>) no-repeat; background-position: center center;background-size: 35px;"><span class="logo-text">WABestie</span></a>
        <div class="sidebar-user-switcher user-activity-online">
            <a href="#">
                <img src="<?= _assets() ?>/images/avatars/avatartest.png">
                <span class="activity-indicator"></span>
                <span class="user-info-text"><?= $user->username ?><br><span class="user-state-info">WA Bestie</span></span>
            </a>
        </div>
    </div>
    <div class="app-menu">
        <ul class="accordion-menu">
            ...
            <li>
                <a href="<?= base_url('blast') ?>" class="active"><i class="material-icons-two-tone">question_answer</i>WhatsApp Broadcast</a>
            </li>
            <li>
            ...
            <li>
                <a href="<?= base_url('invoice') ?>" class="active"><i class="material-icons-two-tone">send</i>Invoice</a>
            </li>
            <li class="sidebar-title">
                Other
            </li>
            ...
            <?php if ($user->level == 1) { ?>
                ...
                <li>
                    <a href="<?= base_url('pricelist') ?>" class="active"><i class="material-icons-two-tone">account_circle</i>Pricelist</a>
                </li>
            <?php } ?>
            <li>
