                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-12 col-xl-6 col-lg-6 col-md-6">
                                ...
                                <input type="text" name="operator" class="form-control" autocomplete="off">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 col-xl-6 col-lg-6 col-md-6">
                        ...
                        <div class="row">
                            <div class="col-12 col-xl-6 col-lg-6 col-md-6">
                                <label class="form-label">WA Lembaga</label>
                                <input type="text" name="wa_bisnis" class="form-control" required>
                            </div>
                            <div class="col-12 col-xl-6 col-lg-6 col-md-6">
                                <label class="form-label">WA Operator</label>
                                <input type="text" name="wa_operator" class="form-control" autocomplete="off">
                            </div>
                        </div>
                        <div id="email">
                        ...
                        <div>
                            <span>
                                <label class="form-label">Pricelist Paket</label>
                                <select name="id_pricelist" class="form-select">
                                    <?php foreach ($pricelist->result() as $d) : ?>
