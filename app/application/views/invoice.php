                                    ...
                                    <div class="card-body">
                                        <div class="widget-stats-container d-flex">
                                            ...
                                            <div class="widget-stats-content flex-fill">
                                                <span class="widget-stats-title"><?= $pesan + $reports ?> Pesan</span>
                                                <span class="widget-stats-amount"><?= rupiah(($pesan + $reports) * 10) ?></span>
                                                <span>Rp.10/pesan</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card widget widget-stats">
                                    <div class="card-body">
                                        <div class="widget-stats-container d-flex">
                                            ...
                                            <div class="widget-stats-content flex-fill">
                                                <span class="widget-stats-title"><?= $broadcast ?> Broadcast</span>
                                                <span class="widget-stats-amount"><?= rupiah($broadcast * 10) ?></span>
                                                <span>Rp.10/pesan</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card widget widget-stats">
                                    <div class="card-body">
                                        <div class="widget-stats-container d-flex">
                                            ...
                                            <div class="widget-stats-content flex-fill">
                                                <span class="widget-stats-title">Tagihan</span>
                                                <span class="widget-stats-amount"><?= rupiah($broadcast * 10 + $pesan * 10 + $reports * 10) ?></span>
                                                <span><?= $broadcast + $pesan + $reports ?> pesan</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
