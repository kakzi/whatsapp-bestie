...
(100) NOT NULL,
  `level` enum
('1','2') NOT NULL DEFAULT '2' COMMENT '1 = ADMIN\r\n2 = CS',
  `limit_device` int
(11) NOT NULL,
  `status` enum
('active','inactive','expired') NOT NULL,
...
INSERT INTO `account` (`
id`,`username
`, `password`, `api_key`, `level`, `limit_device`, `status`, `expired`) VALUES
...
(11) NOT NULL,
  `type` enum
('Text','Text & Media','Quick Reply Button','Url & Call Button','List Button') NOT NULL,
  `keyword` varchar
(255) CHARACTER
SET utf8
NOT NULL,
...
(11) NOT NULL,
  `status` enum
('pending','terkirim','gagal') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(255) DEFAULT NULL,
  `status` enum
('MENUNGGU JADWAL','GAGAL','TERKIRIM') NOT NULL DEFAULT 'MENUNGGU JADWAL',
...
(255) NOT NULL,
  `status` enum
('Failed','Sent') NOT NULL,
  `type` enum
('single','received','api') NOT NULL,
...
(255) NOT NULL,
  `install_in` int
(11) NOT NULL COMMENT '1 = HOSTING 2 = LOCAL'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
